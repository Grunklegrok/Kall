...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("target_industry", sa.String()),
        ...
        sa.Column("time_per_week_hours", sa.Integer()),
        sa.Column("budget_preference", sa.String()),
    ...
    op.create_table(
        ...
        sa.Column("current_strengths", sa.JSON(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("user_id", sa.Integer(), sa.ForeignKey("user.id"), nullable=False),
        sa.Column("growth_plan_id", sa.Integer(), sa.ForeignKey("careergrowthplan.id"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Integer(), sa.ForeignKey("user.id"), nullable=False),
        sa.Column("growth_plan_id", sa.Integer(), sa.ForeignKey("careergrowthplan.id"), nullable=False),
        sa.Column("milestone_id", sa.Integer(), sa.ForeignKey("growthmilestone.id")),
